...
# Define the model before calculating the SS
...
class HANKModelClass(EconModelClass,GEModelClass):
    ...
    def settings(self):
        ...
        self.unknowns = ['L','pi_w'] # endogenous inputs
        self.targets = ['clearing_A','NKWC_res'] # targets
    ...
    def setup(self):
        ...
        par.jump_chi = 0.00 # initial jump
        par.rho_chi = 0.00 # AR(1) coefficeint
        par.std_chi = 0.00 # std.
